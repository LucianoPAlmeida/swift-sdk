...
/** IntentRequest. */
public struct IntentRequest: JSONDecodable, JSONEncodable {
    ...
    /**
     Initialize a `IntentRequest` with member variables.
     ...
     - returns: An initialized `IntentRequest`.
    */
    ...
    // MARK: JSONDecodable
    /// Used internally to initialize a `IntentRequest` model from JSON.
    ...
    // MARK: JSONEncodable
    /// Used internally to serialize a `IntentRequest` model to JSON.
