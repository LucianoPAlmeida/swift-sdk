...
public struct WorkspaceExportResponse: JSONDecodable, JSONEncodable {
    ...
    */
    public init(name: String, description: String, language: String, metadata: Any, created: String, updated: String, workspaceID: String, status: String, intents: [IntentExportResponse]? = nil, entities: [EntityExportResponse]? = nil, counterexamples: [ExampleResponse]? = nil, dialogNodes: [DialogNodeResponse]? = nil) {
        self.name = name
