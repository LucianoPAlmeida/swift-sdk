...
public struct CreateWorkspace: JSONDecodable, JSONEncodable {
    ...
    */
    public init(name: String? = nil, description: String? = nil, language: String? = nil, metadata: Any? = nil, intents: [CreateIntent]? = nil, entities: [CreateEntity]? = nil, dialogNodes: [CreateDialogNode]? = nil, counterexamples: [CreateExample]? = nil) {
        self.name = name
