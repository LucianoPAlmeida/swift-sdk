...
/** WorkspaceRequest. */
public struct WorkspaceRequest: JSONDecodable, JSONEncodable {
    ...
    /**
     Initialize a `WorkspaceRequest` with member variables.
     ...
     - returns: An initialized `WorkspaceRequest`.
    */
    public init(name: String? = nil, description: String? = nil, language: String? = nil, metadata: Any? = nil, counterexamples: [CreateExample]? = nil) {
        self.name = name
    ...
    // MARK: JSONDecodable
    /// Used internally to initialize a `WorkspaceRequest` model from JSON.
    ...
    // MARK: JSONEncodable
    /// Used internally to serialize a `WorkspaceRequest` model to JSON.
